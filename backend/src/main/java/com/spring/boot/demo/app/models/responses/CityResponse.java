...
public class CityResponse implements IResponse
{
    private String key;
    ...
    protected CityResponse()
    {

    }

    public CityResponse(String key, Integer code, String name, Double latitude, Double longitude, String _class)
    {
        super();
        this.key = key;
        this.code = code;
