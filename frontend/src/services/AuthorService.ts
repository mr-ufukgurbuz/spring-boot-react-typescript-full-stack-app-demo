...
class AuthorService 
{
    ...
    async retrieveAllAuthors():Promise<AuthorResponse[]>
    {
        ...
        try 
        {
            const response = await axios.get<AuthorResponse[]>(API_URL + ROUTES.AUTHORS);
    ...
    async retrieveAuthor(key: number):Promise<AuthorResponse>
    {
        ...
        try 
        {
            const response = await  axios.get<AuthorResponse>(API_URL + ROUTES.AUTHORS + "/" + key)
    ...
    async createAuthor(author:AuthorRequest):Promise<AuthorResponse>
    {
        ...
        try 
        {
            const response = await  axios.post<AuthorResponse>(API_URL + ROUTES.AUTHORS, author);
    ...
    async updateAuthor(author:AuthorRequest):Promise<AuthorResponse>
    {
        ...
        try 
        {
            const response = await  axios.put<AuthorResponse>(API_URL + ROUTES.AUTHORS, author);
    ...
    async deleteAuthor(key: number):Promise<AuthorResponse>
    {
        ...
        try 
        {
            const response = await  axios.delete<AuthorResponse>(API_URL + ROUTES.AUTHORS + "/" + key)
