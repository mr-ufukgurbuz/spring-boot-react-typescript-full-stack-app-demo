...
class BookJPAService 
{
    ...
    async retrieveAllBooks():Promise<BookResponse[]>
    {
        ...
        try 
        {
            const response = await axios.get<BookResponse[]>(API_URL + "/jpa" + ROUTES.BOOKS);
    ...
    async retrieveBook(key: number):Promise<BookResponse>
    {
        ...
        try 
        {
            const response = await  axios.get<BookResponse>(API_URL + "/jpa" + ROUTES.BOOKS + "/" + key)
    ...
    async createBook(book:BookRequest):Promise<BookResponse>
    {
        ...
        try 
        {
            const response = await  axios.post<BookResponse>(API_URL + "/jpa" + ROUTES.BOOKS, book);
    ...
    async updateBook(book:BookRequest):Promise<BookResponse>
    {
        ...
        try 
        {
            const response = await  axios.put<BookResponse>(API_URL + "/jpa" + ROUTES.BOOKS, book);
    ...
    async deleteBook(key: number):Promise<BookResponse>
    {
        ...
        try 
        {
            const response = await  axios.delete<BookResponse>(API_URL + "/jpa" + ROUTES.BOOKS + "/" + key)
...
export default new BookJPAService()